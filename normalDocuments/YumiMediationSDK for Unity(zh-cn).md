...
- CocoaPods (推荐)
  ...
  - 如果您需要聚合其他平台
    ...
    ```ruby
    pod "YumiMediationAdapters", :subspecs => ['AdColony','AdMob','AppLovin','Baidu','Chartboost','Domob','Facebook','GDT','InMobi','IronSource','StartApp','Unity','Vungle','Centrixlink','Mintegral','OneWay','TouTiao','PlayableAds']
    ```
